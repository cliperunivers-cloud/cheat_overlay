...
class _OverlayWidgetState extends State<OverlayWidget> {
      ...
      children: [
        ...
        Container(
          ...
          child: ElevatedButton(
            onPressed: _isScanning || _searchValue.isEmpty ? null : _performScan,
      ...
      children: [
        ...
        Expanded(
          child: _buildActionButton(
            ...
            onPressed: _isScanning || _searchResults.isEmpty ? null : _performNextScan,
          ),
        ),
        const SizedBox(width: 6),
        Expanded(
  ...
  Future<void> _performNextScan() async {
    ...
    final filtered = _searchResults
        .where((e) => e.contains(_searchValue))
        .toList();

    if (mounted) {
      setState(() {
        _searchResults = filtered.isEmpty 
