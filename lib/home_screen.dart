              ...
              children: [
                        ...
                        Row(
                          children: [
                            Container(
                              padding: const EdgeInsets.all(8),
                              decoration: BoxDecoration(
                                color: widget.isOverlayShowing
                                    ? Colors.green.withOpacity(0.2)
                                    : Colors.grey.withOpacity(0.2),
                                shape: BoxShape.circle,
                              ),
                              child: Icon(
                                widget.isOverlayShowing
                                    ? Icons.visibility
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: _isLoading ? null : widget.onToggleOverlay,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: widget.isOverlayShowing
                          ? Colors.red.shade700
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          '3. Klik "Buka Overlay"\n'
                          '4. Akan muncul logo 🎯 di pojok kiri atas\n'
                          '5. Klik logo untuk membuka menu lengkap\n'
                          '6. Geser logo untuk memindahkan posisi',
                          style: TextStyle(
                            color: Colors.grey.shade400,
                            fontSize: 12,
                            height: 1.6,
